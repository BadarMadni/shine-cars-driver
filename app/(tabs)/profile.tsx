...
export default function ProfileScreen() {
  ...
  const rows = [
    ...
    { icon: "mail-outline" as const, label: "Email", value: driver?.email || "", editable: false },
...
const styles = StyleSheet.create({
  ...
  avatarCircle: {
    width: 80, height: 80, borderRadius: 40, backgroundColor: "rgba(245,166,35,0.15)",
  ...
  input: {
    color: COLORS.white, fontSize: 15, fontWeight: "600", marginTop: 2,
    borderBottomWidth: 1, borderBottomColor: COLORS.crimson, paddingBottom: 4,
  },
  saveBtn: {
  ...
  logoutBtn: {
    ...
    backgroundColor: "rgba(239,68,68,0.1)", borderRadius: 12, paddingVertical: 16,
