...
export default StyleSheet.create({
  ...
  statusCard: {
    backgroundColor: "rgba(245,166,35,0.1)", borderRadius: 12, paddingHorizontal: 14, paddingVertical: 10,
    marginBottom: 12, borderWidth: 1, borderColor: "rgba(245,166,35,0.2)",
    flexDirection: "row", alignItems: "center", justifyContent: "space-between",
  },
  statusLabel: { color: COLORS.gray400, fontSize: 12 },
  statusValue: { color: COLORS.gold, fontSize: 14, fontWeight: "800" },
  card: {
  ...
  cardTitle: { color: COLORS.white, fontSize: 14, fontWeight: "700", marginBottom: 10 },
  ...
  tripLine: { width: 2, height: 14, backgroundColor: "rgba(255,255,255,0.1)", marginLeft: 4, marginVertical: 2 },
  ...
  navBtn: {
    flexDirection: "row", alignItems: "center", justifyContent: "center",
    gap: 8, backgroundColor: "#3B82F6", borderRadius: 12, paddingVertical: 10, marginTop: 10,
  },
